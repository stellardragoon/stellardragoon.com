...
export const assetManifest: Record<string, AssetEntry> = {
	...
	'prologue-video': {
		src: '/assets/prologue-bg.mp4',
		type: 'video',
		priority: 'critical',
		routes: ['/']
	},
	'worldview-bg': {
		src: '/assets/city-concept.jpg',
		type: 'image',
		priority: 'critical',
		routes: ['/']
	},
	...
	// ── Home page (/): Lazy ───────────────────────────────
	'rioze-silhouette': {
		src: '/assets/rioze-silhouette.png',
		type: 'image',
		priority: 'lazy'
	},
	'rioze-color': { src: '/assets/rioze-color.webp', type: 'image', priority: 'lazy' },
	'rutsuki-silhouette': {
		src: '/assets/rutsuki-silhouette.png',
		type: 'image',
		priority: 'lazy'
	},
	'rutsuki-color': {
		src: '/assets/rutsuki-color.webp',
		type: 'image',
		priority: 'lazy'
	},
	'work-01': { src: '/assets/work-01.jpg', type: 'image', priority: 'lazy' },
	'work-02': { src: '/assets/work-02.jpg', type: 'image', priority: 'lazy' },
	'work-03': { src: '/assets/work-03.jpg', type: 'image', priority: 'lazy' },

	'planet-map': { type: 'image', src: '/assets/map.png', priority: 'critical' }
}
...
export const karnethNav: KarnethNavItem[] = [{ label: 'karneth', href: '/karneth' }]
